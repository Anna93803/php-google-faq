                ...
                <div>
                    ...
                    foreach($faqList as $faq) {
                        ...
                        if(key_exists("subtitle" , $faq)) {
                            echo "<h4>" . $faq["subtitle"] . "</h4>";
                            foreach($faq["subparagrafo"] as $subtext) {
                                echo "<p>" . $subtext . "</p>";
                            }
                        }
                    }?>
